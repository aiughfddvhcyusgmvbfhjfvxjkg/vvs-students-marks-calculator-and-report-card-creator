...
st.title("Marks Calculator")
    ...
    # Custom CSS for convert marks section
st.markdown("""
<style>
        .convert-container {
            display: flex;
...
div.stCheckbox {
    ...
    # Convert checkbox next to text in a container
st.markdown('<div class="convert-container">', unsafe_allow_html=True)
st.markdown('<span class="convert-text">Convert Marks</span>', unsafe_allow_html=True)
    if st.checkbox("", key="convert_checkbox", label_visibility="collapsed"):
